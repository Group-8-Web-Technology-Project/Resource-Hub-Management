          ...
          <tr>
            <td align='center' valign='top' style='padding: 36px 10px 10px 10px;'>
              <div >
                ...
                <p style='margin:1rem;font-family: 'Source Sans Pro', sans-serif;font-size: 2.3rem;color: #303030;'>ResourceHub</p>
    ...
    <tr>
      <td align='center' bgcolor='#e9ecef'>
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
                    ...
                    <table border='0' cellpadding='0' cellspacing='0'>
                      <tr>
                        <td align='center' bgcolor='#46d9a9' style='border-radius: 6px;'>
                          /*<a href='' target='_blank' style='display: inline-block; padding: 16px 36px; font-family: \"Source Sans Pro\", Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;color: white !important;'>Yes, It's Me. Confirm the Email</a>*/
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <!-- start copy -->
          <tr>
            <td align='left' bgcolor='#ffffff' style='padding: 24px; font-family: 'Source Sans Pro', sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf'>
    ...
    <tr>
      <td align='center' bgcolor='#e9ecef' style='padding: 24px;'>
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
          ...
          <!-- start permission -->
          <tr>
            <td align='center' bgcolor='#e9ecef' style='padding: 12px 24px; font-family: 'Source Sans Pro', sans-serif; font-size: 14px; line-height: 20px; color: #666;'>
...
//https://cheerless-torpedoes.000webhostapp.com/controllers/login/verify.php?code=$code
?>